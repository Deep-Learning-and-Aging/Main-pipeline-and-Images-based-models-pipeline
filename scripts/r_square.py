...
class MyRSquare(Metric):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.squared_sum = self.add_weight(name="squared_sum", shape=self.y_shape, initializer="zeros",
                                           dtype=self.mydtype)
        self.sum = self.add_weight(name="sum", shape=self.y_shape, initializer="zeros", dtype=self.mydtype)
        self.res = self.add_weight(name="residual", shape=self.y_shape, initializer="zeros", dtype=self.mydtype)
        self.count = self.add_weight(name="count", shape=self.y_shape, initializer="zeros", dtype=self.mydtype)
