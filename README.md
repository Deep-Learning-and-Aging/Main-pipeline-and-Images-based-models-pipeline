...
Only a CPU is required for this tutorial with 2 Gb of RAM. All the results needing heavy and long lasting computations are given. To host the project on your local computer, 7 Gb of memory is needed: 2.5 Gb for the dependencies and 4 Gb for the data. 
